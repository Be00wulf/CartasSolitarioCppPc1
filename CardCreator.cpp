...
DoublyLinkedList<Card*>* CardCreator::createCards(){    //puntero a una lista doblemente enlazada que contiene cartas. Esta lista se crea dentro de la función.
    actualColor = colors[0];        //actual en rojo, el primer color en el arreglo 
    for(int i = 1; i < 5; i++){   //recorriendo los tipos de cartas 
        ...
        for(int j = 0; j < 13; j++){    //recorre los valores de las cartas 1-13        26n     26r              asignandole valor
    ...
    for(int i = 1; i < 5; i++){      //2. Itera por cada una de los tipos i: <3 <> E3 !!        establece color al tipo  
